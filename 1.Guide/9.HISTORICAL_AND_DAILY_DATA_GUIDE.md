...
2.  **Chạy các file Migration cần thiết:**
    ...
    -   Chạy lần lượt các lệnh sau theo đúng thứ tự:
        ...
        \i /var/www/Ditavn-Ads-Auto/migrations/003_add_sp_search_term_report_table.sql.txt

        -- Bảng báo cáo Sales & Traffic
        \i /var/www/Ditavn-Ads-Auto/migrations/004_add_sales_and_traffic_tables.sql.txt

        -- Bảng hàng đợi yêu cầu báo cáo (quan trọng cho quy trình mới)
        \i /var/www/Ditavn-Ads-Auto/migrations/005_add_report_requests_table.sql.txt

        -- Bảng báo cáo Sponsored Brands Search Term
        \i /var/www/Ditavn-Ads-Auto/migrations/008_add_sb_search_term_report_table.sql.txt
        
        -- Bảng báo cáo Sponsored Display Targeting
        \i /var/www/Ditavn-Ads-Auto/migrations/009_add_sd_targeting_report_table.sql.txt
        ```
